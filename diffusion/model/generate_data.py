...
def load_data_text(
    ...
    Each seq is a (bsz, len, h) float tensor, and the kwargs dict contains zero or
    ...
    data = get_corpus(data_args, seq_len, split=split, loaded_vocab=loaded_vocab)
...
def get_corpus(data_args, seq_len, split='train', loaded_vocab=None):
    ...
    dataset = helper_tokenize(sentence_lst, vocab_dict, seq_len)
    return dataset
